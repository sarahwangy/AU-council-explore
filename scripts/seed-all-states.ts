...
const COUNCILS = [
  // QLD
  { id: 'brisbane', name: 'Brisbane City Council', state: 'QLD', region: 'brisbane-north', population: 1238159, areaSqKm: 1338, website: 'https://www.brisbane.qld.gov.au', libraryUrl: 'https://www.brisbane.qld.gov.au/library' },
  { id: 'gold-coast-qld', name: 'City of Gold Coast', state: 'QLD', region: 'gold-coast', population: 679127, areaSqKm: 1356, website: 'https://www.goldcoast.qld.gov.au', libraryUrl: 'https://www.goldcoast.qld.gov.au/library' },
  ...
  { id: 'cairns-qld', name: 'Cairns Regional Council', state: 'QLD', region: 'qld-regional', population: 161000, areaSqKm: 4156, website: 'https://www.cairns.qld.gov.au', libraryUrl: 'https://www.cairns.qld.gov.au/library' },
  { id: 'townsville-qld', name: 'Townsville City Council', state: 'QLD', region: 'qld-regional', population: 200000, areaSqKm: 3732, website: 'https://www.townsville.qld.gov.au', libraryUrl: 'https://www.townsville.qld.gov.au/libraries' },
  { id: 'toowoomba-qld', name: 'Toowoomba Regional Council', state: 'QLD', region: 'qld-regional', population: 178000, areaSqKm: 12980, website: 'https://www.toowoomba.qld.gov.au', libraryUrl: 'https://www.toowoomba.qld.gov.au/library' },

  // SA
  { id: 'adelaide-sa', name: 'City of Adelaide', state: 'SA', region: 'adelaide-metro', population: 24658, areaSqKm: 15.6, website: 'https://www.cityofadelaide.com.au', libraryUrl: 'https://www.cityofadelaide.com.au/community/libraries' },
  ...
  { id: 'stirling-wa', name: 'City of Stirling', state: 'WA', region: 'perth-metro', population: 224000, areaSqKm: 103, website: 'https://www.stirling.wa.gov.au', libraryUrl: 'https://www.stirling.wa.gov.au/attractions-and-recreation/libraries-and-hubs' },
  { id: 'wanneroo-wa', name: 'City of Wanneroo', state: 'WA', region: 'perth-metro', population: 230000, areaSqKm: 685, website: 'https://www.wanneroo.wa.gov.au', libraryUrl: 'https://www.wanneroo.wa.gov.au/libraries' },
  { id: 'joondalup-wa', name: 'City of Joondalup', state: 'WA', region: 'perth-metro', population: 175000, areaSqKm: 99, website: 'https://www.joondalup.wa.gov.au', libraryUrl: 'https://www.joondalup.wa.gov.au/community-and-spaces/libraries' },
  ...
  { id: 'rockingham-wa', name: 'City of Rockingham', state: 'WA', region: 'perth-south', population: 145000, areaSqKm: 261, website: 'https://www.rockingham.wa.gov.au', libraryUrl: 'https://www.rockingham.wa.gov.au/facilities-and-recreation/libraries' },
  { id: 'mandurah-wa', name: 'City of Mandurah', state: 'WA', region: 'perth-south', population: 93000, areaSqKm: 186, website: 'https://www.mandurah.wa.gov.au', libraryUrl: 'https://www.mandurah.wa.gov.au/facilities/libraries' },
  ...
  { id: 'glenorchy-tas', name: 'Glenorchy City Council', state: 'TAS', region: 'hobart-metro', population: 47000, areaSqKm: 86, website: 'https://www.gcc.tas.gov.au', libraryUrl: 'https://libraries.tas.gov.au' },
  { id: 'clarence-tas', name: 'Clarence City Council', state: 'TAS', region: 'hobart-metro', population: 57000, areaSqKm: 376, website: 'https://www.ccc.tas.gov.au', libraryUrl: 'https://libraries.tas.gov.au' },
  ...
  { id: 'meander-valley-tas', name: 'Meander Valley Council', state: 'TAS', region: 'launceston', population: 21000, areaSqKm: 2799, website: 'https://www.mvcouncil.tas.gov.au', libraryUrl: 'https://libraries.tas.gov.au' },
  { id: 'devonport-tas', name: 'Devonport City Council', state: 'TAS', region: 'tas-regional', population: 25000, areaSqKm: 111, website: 'https://www.devonport.tas.gov.au', libraryUrl: 'https://libraries.tas.gov.au' },
  { id: 'burnie-tas', name: 'Burnie City Council', state: 'TAS', region: 'tas-regional', population: 18000, areaSqKm: 610, website: 'https://www.burnie.net', libraryUrl: 'https://libraries.tas.gov.au' },
  ...
  { id: 'palmerston-nt', name: 'City of Palmerston', state: 'NT', region: 'darwin-metro', population: 38000, areaSqKm: 65, website: 'https://www.palmerston.nt.gov.au', libraryUrl: 'https://www.palmerston.nt.gov.au/library' },
  { id: 'alice-springs-nt', name: 'Alice Springs Town Council', state: 'NT', region: 'alice-springs', population: 28000, areaSqKm: 1152, website: 'https://www.alicesprings.nt.gov.au', libraryUrl: 'https://www.alicesprings.nt.gov.au/residents/facilities/library' },
  { id: 'litchfield-nt', name: 'Litchfield Council', state: 'NT', region: 'darwin-metro', population: 22000, areaSqKm: 4565, website: 'https://www.litchfield.nt.gov.au', libraryUrl: 'https://www.litchfield.nt.gov.au/community/library' },
  { id: 'katherine-nt', name: 'Katherine Town Council', state: 'NT', region: 'nt-regional', population: 6500, areaSqKm: 105, website: 'https://www.katherine.nt.gov.au', libraryUrl: 'https://www.katherine.nt.gov.au/residents/library/about' },
]
